...
//! [`RedisCache`]: crate::cache::RedisCache
//! [`Ignore`]: crate::config::ignore::Ignore
...
#[cfg(not(any(feature = "bb8", feature = "deadpool")))]
compile_error!("either of the features `bb8` and `deadpool` *must* be enabled");
